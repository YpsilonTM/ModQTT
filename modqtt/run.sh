...
config = {
    ...
    'mqtt': {
        ...
        'discovery_device_name': options.get('discovery_device_name', 'Sungrow Inverter'),
        'discovery_device_manufacturer': options.get('discovery_device_manufacturer', 'Sungrow'),
        'discovery_device_model': options.get('discovery_device_model', 'ModQTT Bridge'),
    },
